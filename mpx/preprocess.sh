...
bash run_nf.sh $DIR/ $DIR/combined_seqs.fasta $DIR/formatted_metadata.tsv --reference $DIR/reference_seq.fasta --align_mode minimap2 --threads $CORES --strain_column "strain" --date_column "Date" --skip_clade_annotations true --tree_file $DIR/nextstrain_monkeypox_hmpxv1_timetree.nwk
